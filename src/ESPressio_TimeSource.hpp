...
namespace ESPressio {
    ...
    namespace Timing {
        ...
        class HighResolutionTimeSourceT :
            public ITimeSource {
            ...
            private:
                ...
                mutable typename TLockPolicy::Mutex
                    _tickMutex;
            ...
            public:
                ...
                uint64_t
                GetTicksPerSecond() const override {
                    #if defined(ESP32)
                        ...
                        return
                            static_cast<uint64_t>(
                                SourceClock::period::den /
                                SourceClock::period::num
                            );
                ...
                static HighResolutionTimeSourceT*
                GetInstance() {
                    static
